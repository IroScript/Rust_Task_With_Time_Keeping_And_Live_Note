...
curl -s https://api.github.com/repos/IroScript/Rust_Task_With_Time_Keeping_And_Live_Note/commits/main | Select-String -Pattern '"sha"' | Select-Object -First 1
...
start https://github.com/IroScript/Rust_Task_With_Time_Keeping_And_Live_Note
