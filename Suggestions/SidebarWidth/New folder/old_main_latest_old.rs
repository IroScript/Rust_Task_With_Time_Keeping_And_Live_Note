        ...
        .show(ui, |ui| {
            ...
            render_section(ui, &format!("ADD CUSTOM TEXT  [{}]", state.quotes.len() + 1), u32_to_color32(state.text_style.panel_text_color), |ui| {
                ...
                egui::Frame::none()
                    ...
                    .inner_margin(0.0)  // Remove inner margin to match button width
                    .show(ui, |ui| {
                        ...
                        let text_width = (section_content_width - 12.0).max(50.0);  // Same as button
                ...
                // --- Supporting text input (same width as Add Text button) ---
